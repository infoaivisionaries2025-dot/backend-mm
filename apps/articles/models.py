...
class Article(models.Model):
    ...
    cover_image_thumbnail = models.URLField(blank=True)
    cover_image_medium = models.URLField(blank=True)
    cover_image_large = models.URLField(blank=True)
    ...
    cover_image_size = models.PositiveIntegerField(null=True, blank=True, help_text="Optimized size in bytes")
    cover_image_format = models.CharField(max_length=10, blank=True)
